...
class CollectorEngine {
  constructor() {
    ...
    this.discoveryKeywords = {
      shopping: ['ÃÂ¬ÃÂ¿ÃÂ ÃÂ­ÃÂÃÂ¡ ÃÂ­ÃÂÃÂ ÃÂ¬ÃÂÃÂ¸', 'ÃÂ­ÃÂÃÂ«ÃÂ«ÃÂÃÂ ÃÂ¬ÃÂ¶ÃÂÃÂ¬ÃÂ²ÃÂ', 'ÃÂ¬ÃÂÃÂÃÂ«ÃÂ¦ÃÂ¬ ÃÂ­ÃÂÃÂ ÃÂ¬ÃÂÃÂ¸', 'ÃÂ¬ÃÂÃÂÃÂ«ÃÂ§ÃÂÃÂ¬ÃÂ¡ÃÂ´ ÃÂ¬ÃÂ§ÃÂÃÂªÃÂµÃÂ¬', 'ÃÂ¬ÃÂÃÂ¼ÃÂ­ÃÂÃÂ ÃÂ¬ÃÂ¶ÃÂÃÂ¬ÃÂ²ÃÂ', 'ÃÂ«ÃÂ§ÃÂÃÂ­ÃÂÃÂ¬ ÃÂ­ÃÂÃÂ ÃÂ¬ÃÂÃÂ¸'],
      issue: ['ÃÂ¬ÃÂÃÂÃÂ«ÃÂ³ÃÂ´', 'ÃÂ«ÃÂÃÂ¼ÃÂ«ÃÂÃÂ', 'ÃÂ­ÃÂÃÂÃÂ¬ÃÂ ÃÂ ÃÂ¬ÃÂÃÂ¤ÃÂ¬ÃÂÃÂÃÂªÃÂ°ÃÂ', 'ÃÂ¬ÃÂÃÂ´ÃÂ¬ÃÂÃÂ ÃÂ¬ÃÂ ÃÂÃÂ«ÃÂ¦ÃÂ¬', 'breaking news'],
      personal: ['ÃÂ­ÃÂÃÂ ÃÂªÃÂ³ÃÂµÃÂ¬ÃÂÃÂ ', 'ÃÂ«ÃÂÃÂ¸ÃÂ­ÃÂÃÂÃÂ¬ÃÂÃÂ°', 'ÃÂ­ÃÂÃÂ¬ÃÂ­ÃÂÃÂ¸ÃÂ­ÃÂÃÂ´ÃÂ«ÃÂ¦ÃÂ¬ÃÂ¬ÃÂÃÂ¤ ÃÂªÃÂ³ÃÂµÃÂªÃÂ°ÃÂ']
    };

    // Category keywords for classification
    this.categoryKeywords = {
      shopping: ['ÃÂ­ÃÂÃÂ ÃÂ¬ÃÂÃÂ¸', 'ÃÂ¬ÃÂ¿ÃÂ ÃÂ­ÃÂÃÂ°', 'ÃÂ­ÃÂÃÂ«ÃÂ«ÃÂÃÂ', 'ÃÂ¬ÃÂÃÂ¸ÃÂ¬ÃÂÃÂ¼', 'ÃÂ¬ÃÂµÃÂÃÂ¬ÃÂ ÃÂÃÂªÃÂ°ÃÂ', 'ÃÂ¬ÃÂ¶ÃÂÃÂ¬ÃÂ²ÃÂÃÂ­ÃÂÃÂ', 'ÃÂ«ÃÂ¦ÃÂ¬ÃÂ«ÃÂ·ÃÂ°', 'ÃÂªÃÂµÃÂ¬ÃÂ«ÃÂ§ÃÂ¤', 'ÃÂ«ÃÂ°ÃÂ°ÃÂ¬ÃÂÃÂ¡', 'ÃÂ¬ÃÂ§ÃÂÃÂªÃÂµÃÂ¬', 'ÃÂªÃÂ°ÃÂÃÂ¬ÃÂÃÂ±ÃÂ«ÃÂ¹ÃÂ', 'ÃÂ¬ÃÂÃÂ¸ÃÂ«ÃÂ°ÃÂÃÂ¬ÃÂÃÂ±'],
      issue: ['ÃÂ¬ÃÂÃÂÃÂ«ÃÂ³ÃÂ´', 'ÃÂ«ÃÂÃÂ¼ÃÂ«ÃÂÃÂ', 'ÃÂªÃÂ¸ÃÂ´ÃÂªÃÂ¸ÃÂ', 'ÃÂ­ÃÂÃÂÃÂ¬ÃÂ ÃÂ', 'ÃÂ¬ÃÂÃÂ´ÃÂ¬ÃÂÃÂ', 'ÃÂ«ÃÂÃÂ´ÃÂ¬ÃÂÃÂ¤', 'ÃÂªÃÂ·ÃÂÃÂ¬ÃÂ ÃÂ', 'ÃÂ¬ÃÂÃÂ ÃÂªÃÂ±ÃÂ°', 'ÃÂ¬ÃÂ ÃÂÃÂ¬ÃÂ¹ÃÂ', 'ÃÂªÃÂ²ÃÂ½ÃÂ¬ÃÂ ÃÂ', 'ÃÂ¬ÃÂÃÂ¬ÃÂªÃÂ±ÃÂ´'],
      personal: ['ÃÂ­ÃÂÃÂ', 'ÃÂ«ÃÂÃÂ¸ÃÂ­ÃÂÃÂÃÂ¬ÃÂÃÂ°', 'ÃÂ«ÃÂ°ÃÂ©ÃÂ«ÃÂ²ÃÂ', 'ÃÂ¬ÃÂ ÃÂÃÂ«ÃÂÃÂµ', 'ÃÂªÃÂ²ÃÂ½ÃÂ­ÃÂÃÂ', 'ÃÂ­ÃÂÃÂ¬ÃÂ­ÃÂÃÂ¸ÃÂ­ÃÂÃÂ´ÃÂ«ÃÂ¦ÃÂ¬ÃÂ¬ÃÂÃÂ¤', 'ÃÂªÃÂ°ÃÂÃÂ¬ÃÂÃÂ', 'ÃÂªÃÂ°ÃÂÃÂ¬ÃÂÃÂ´ÃÂ«ÃÂÃÂ']
    };
  ...
  /**
   * Full auto collection cycle: keyword search ÃÂ¢ÃÂÃÂ profile scrape ÃÂ¢ÃÂÃÂ save to DB
   */
